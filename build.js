...
var _componentsBuscador = require("./components/Buscador");

var _componentsBuscador2 = _interopRequireDefault(_componentsBuscador);
...
var _InputBuscar = require("./InputBuscar");

var _InputBuscar2 = _interopRequireDefault(_InputBuscar);

var _Resultado = require("./Resultado");

var _Resultado2 = _interopRequireDefault(_Resultado);

var Buscador = _react2["default"].createClass({
  ...
  render: function render() {
    return _react2["default"].createElement(
      "div",
      null,
      _react2["default"].createElement(_InputBuscar2["default"], null),
      _react2["default"].createElement(_Resultado2["default"], null)
    );
  }
});
...
},{"./InputBuscar":4,"./Resultado":5,"react":162,"reflux":179}],4:[function(require,module,exports){
'use strict';
...
var _actionsBuscadorActions = require("../actions/BuscadorActions");

var _actionsBuscadorActions2 = _interopRequireDefault(_actionsBuscadorActions);

var InputBuscar = _react2['default'].createClass({
...
},{"../actions/BuscadorActions":1,"react":162,"reflux":179}],5:[function(require,module,exports){
'use strict';
...
var Resultado = _react2['default'].createClass({
  displayName: 'Resultado',

  mixins: [_reflux2['default'].connect(_storesPostStore2['default'], 'poststore')],
  render: function render() {
...
},{"../stores/PostStore":182,"react":162,"reflux":179}],6:[function(require,module,exports){
...
var PostStore = _reflux2['default'].createStore({
  ...
  fetchList: function fetchList(q) {
    ...
    _jquery2['default'].get('http://localhost:3000/api/posts', { q: q }).done(function (data) {
...
},{"../actions/BuscadorActions":1,"jquery":7,"react":162,"reflux":179}]},{},[2]);
